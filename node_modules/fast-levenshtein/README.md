...
* Comprehensive test suite and performance ***REMOVED***chmark.
...
***REMOVED***chmarked against other node.js levenshtein distance modules (on Macbook Air 2012, Core i7, 8GB RAM):

```bash
Running suite Implementation comparison [***REMOVED***chmark/speed.js]...
...
You can run this ***REMOVED***chmark yourself by doing:

```bash
$ npm install
$ npm run build
$ npm run ***REMOVED***chmark
```
