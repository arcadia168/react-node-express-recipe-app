# private [![Build Status](https://travis-ci.org/***REMOVED***jamn/private.png?branch=master)](https://travis-ci.org/***REMOVED***jamn/private) [![Greenkeeper badge](https://badges.greenkeeper.io/***REMOVED***jamn/private.svg)](https://greenkeeper.io/)
...
From GitHub:
    ...
    git clone git://github.com/***REMOVED***jamn/private.git
    cd private
    npm install .
...
of the ***REMOVED***efits of traditional data privacy, a la Java or C++:
```js
