...
After having some artificial ***REMOVED***chmarks for some time, __@AndreasMadsen__ published his [`htmlparser-***REMOVED***chmark`](https://github.com/AndreasMadsen/htmlparser-***REMOVED***chmark), which ***REMOVED***chmarks HTML parses based on real-world websites.

At the time of writing, the latest versions of all supported parsers show the following performance characteristics on [Travis CI](https://travis-ci.org/AndreasMadsen/htmlparser-***REMOVED***chmark/builds/10805007) (please note that Travis doesn't guarantee equal conditions for all tests):
