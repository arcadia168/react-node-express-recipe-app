  ...
  Modal.prototype.autoFocus = function autoFocus() {
    ...
    if (dialogElement && !(0, _contains2.default)(dialogElement, currentActiveElement)) {
      ...
      if (!dialogElement.hasAttribute('tabIndex')) {
        (0, _warning2.default)(false, 'The modal content node does not accept focus. For the ***REMOVED***efit of ' + 'assistive technologies, the tabIndex of the node is being set ' + 'to "-1".');
