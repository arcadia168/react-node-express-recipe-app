...
* Updated mongodb-core to 2.0.13.
  ...
  - Refactoring to support pipelining ala 1.4.x branch will retaining the ***REMOVED***efits of the growing/shrinking pool (Issue #146).
...
* Set ssl, sslValidate etc to mongosOptions on url_parser (Issue #1352, https://github.com/ru***REMOVED***stolk).
...
* Remove options check on index creation (Issue #1179, Issue #1183, https://github.com/jdesboeufs, https://github.com/ru***REMOVED***vereecken)
...
* Close db connection on error (Issue #1128, https://github.com/***REMOVED***ighted)
...
* Close db on failed connect so node can exit (Issue #1128, https://github.com/***REMOVED***ighted)
...
1.3.11 2013-07-04
-----------------
* Fixed errors on geoNear and geoSearch (Issue #1024, https://github.com/e***REMOVED***sing)
...
* Sanity checks for GridFS performance with ***REMOVED***chmark added
