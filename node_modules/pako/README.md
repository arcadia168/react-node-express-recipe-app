...
- Almost as fast in modern JS engines as C implementation (see ***REMOVED***chmarks).
...
You can change deflate level to 0 in ***REMOVED***chmark source, to investigate details.
