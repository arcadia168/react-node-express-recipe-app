...

{
  ...
  'targets': [
    ...
    {
      'target_name': 'scaler_***REMOVED***ch',
      'type': 'executable',
      'dependencies': [
        'media',
        'yuv_convert',
      ...
      'sources': [
        'tools/scaler_***REMOVED***ch/scaler_***REMOVED***ch.cc',
      ],
    },
    {
  ...
  'conditions': [
    ...
    ['OS == "win" or toolkit_uses_gtk == 1', {
      'targets': [
        {
          'target_name': 'shader_***REMOVED***ch',
          'type': 'executable',
          'dependencies': [
            'media',
            'yuv_convert',
          ...
          'sources': [
            'tools/shader_***REMOVED***ch/shader_***REMOVED***ch.cc',
            'tools/shader_***REMOVED***ch/cpu_color_painter.cc',
            'tools/shader_***REMOVED***ch/cpu_color_painter.h',
            'tools/shader_***REMOVED***ch/gpu_color_painter.cc',
            'tools/shader_***REMOVED***ch/gpu_color_painter.h',
            'tools/shader_***REMOVED***ch/gpu_painter.cc',
            'tools/shader_***REMOVED***ch/gpu_painter.h',
            'tools/shader_***REMOVED***ch/painter.cc',
            'tools/shader_***REMOVED***ch/painter.h',
            'tools/shader_***REMOVED***ch/window.cc',
            'tools/shader_***REMOVED***ch/window.h',
          ],
          'conditions': [
            ['toolkit_uses_gtk == 1', {
              'dependencies': [
              ...
              'sources': [
                'tools/shader_***REMOVED***ch/window_linux.cc',
              ],
            }],
            ['OS=="win"', {
              'dependencies': [
              ...
              'sources': [
                'tools/shader_***REMOVED***ch/window_win.cc',
              ],
            }],
          ],
        },
    ...
    ['OS == "linux" and target_arch != "arm"', {
      'targets': [
        {
          'target_name': 'tile_render_***REMOVED***ch',
          'type': 'executable',
          'dependencies': [
            '../base/base.gyp:base',
            '../ui/gl/gl.gyp:gl',
          ...
          'sources': [
            'tools/tile_render_***REMOVED***ch/tile_render_***REMOVED***ch.cc',
          ],
        },
      ],
    }],
    ...
    ['OS == "android"', {
      ...
      'targets': [
        ...
        },
        {
          ...
          'sources': [
            'tools/media_***REMOVED***ch/media_***REMOVED***ch.cc',
          ],
        },
      ],
    }]
