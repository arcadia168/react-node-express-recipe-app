...
* [[`241752f381`](https://github.com/nodejs/node-gyp/commit/241752f381)] - Log dist-url. (***REMOVED*** Noordhuis) [#1170](https://github.com/nodejs/node-gyp/pull/1170)
...
* [[`49801716c2`](https://github.com/nodejs/node-gyp/commit/49801716c2)] - **test**: fix test-find-python on v0.10.x buildbot. (***REMOVED*** Noordhuis) [#1172](https://github.com/nodejs/node-gyp/pull/1172)
...
* [[`da9cb5f411`](https://github.com/nodejs/node-gyp/commit/da9cb5f411)] - Delete superfluous .patch files. (***REMOVED*** Noordhuis) [#1122](https://github.com/nodejs/node-gyp/pull/1122)
...
* [[`93d7fa83c8`](https://github.com/nodejs/node-gyp/commit/93d7fa83c8)] - Upgrade semver dependency. (***REMOVED*** Noordhuis) [#1107](https://github.com/nodejs/node-gyp/pull/1107)
...
* [[`37ae7be114`](https://github.com/nodejs/node-gyp/commit/37ae7be114)] - Try python launcher when stock python is python 3. (***REMOVED*** Noordhuis) [#992](https://github.com/nodejs/node-gyp/pull/992)
* [[`e3778d9907`](https://github.com/nodejs/node-gyp/commit/e3778d9907)] - Add lots of findPython() tests. (***REMOVED*** Noordhuis) [#992](https://github.com/nodejs/node-gyp/pull/992)
...
* [[`9c8d275526`](https://github.com/nodejs/node-gyp/commit/9c8d275526)] - Add --devdir flag. (***REMOVED*** Noordhuis) [#916](https://github.com/nodejs/node-gyp/pull/916)
...
* [[`cc778e9215`](https://github.com/nodejs/node-gyp/commit/cc778e9215)] - Override BUILDING_UV_SHARED, BUILDING_V8_SHARED. (***REMOVED*** Noordhuis) [#915](https://github.com/nodejs/node-gyp/pull/915)
...
* [[`ac29d23a7c`](https://github.com/nodejs/node-gyp/commit/ac29d23a7c)] - Upgrade to glob@7.0.3. (***REMOVED*** Noordhuis) [#943](https://github.com/nodejs/node-gyp/pull/943)
...
* [[`8c4b0ffa50`](https://github.com/nodejs/node-gyp/commit/8c4b0ffa50)] - **(SEMVER-MINOR)** Add --cafile command line option. (***REMOVED*** Noordhuis) [#837](https://github.com/nodejs/node-gyp/pull/837)
* [[`b3ad43498e`](https://github.com/nodejs/node-gyp/commit/b3ad43498e)] - **(SEMVER-MINOR)** Make download() function testable. (***REMOVED*** Noordhuis) [#837](https://github.com/nodejs/node-gyp/pull/837)

v3.2.1 2015-12-03
=================

* [[`ab89b477c4`](https://github.com/nodejs/node-gyp/commit/ab89b477c4)] - Upgrade gyp to b3cef02. (***REMOVED*** Noordhuis) [#831](https://github.com/nodejs/node-gyp/pull/831)
* [[`90078ecb17`](https://github.com/nodejs/node-gyp/commit/90078ecb17)] - Define WIN32_LEAN_AND_MEAN conditionally. (***REMOVED*** Noordhuis) [#824](https://github.com/nodejs/node-gyp/pull/824)
...
* [[`817ed9bd78`](https://github.com/nodejs/node-gyp/commit/817ed9bd78)] - Add test for python executable search logic. (***REMOVED*** Noordhuis) [#756](https://github.com/nodejs/node-gyp/pull/756)
* [[`0e2dfda1f3`](https://github.com/nodejs/node-gyp/commit/0e2dfda1f3)] - Fix test/test-options when run through `npm test`. (***REMOVED*** Noordhuis) [#755](https://github.com/nodejs/node-gyp/pull/755)
...
* [[`2ac7de02c4`](https://github.com/nodejs/node-gyp/commit/2ac7de02c4)] - Fix infinite loop with zero-length options. (***REMOVED*** Noordhuis) [#745](https://github.com/nodejs/node-gyp/pull/745)
...
* [[`0fbc387b35`](https://github.com/nodejs/node-gyp/commit/0fbc387b35)] - Update repository URLs. (***REMOVED*** Noordhuis) [#715](https://github.com/nodejs/node-gyp/pull/715)
