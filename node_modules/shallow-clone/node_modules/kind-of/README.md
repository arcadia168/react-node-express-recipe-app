...
***REMOVED***chmarked against [typeof](http://github.com/CodingFu/typeof) and [type-of](https://github.com/ForbesLindesay/type-of).
...
In 7 out of 8 cases, this library is 2x-10x faster than other top libraries included in the ***REMOVED***chmarks. There are a few things that lead to this performance advantage, none of them hard and fast rules, but all of them simple and repeatable in almost any code library:
