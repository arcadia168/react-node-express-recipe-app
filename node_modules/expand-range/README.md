...
Fast, bash-like range expansion. Expand a range of numbers or letters, uppercase or lowercase. See the ***REMOVED***chmarks. Used by micromatch.
...
```sh
# ***REMOVED***chmark/fixtures/alpha-lower.js (29 bytes)
...
# ***REMOVED***chmark/fixtures/alpha-upper.js (29 bytes)
...
# ***REMOVED***chmark/fixtures/padded.js (33 bytes)
...
# ***REMOVED***chmark/fixtures/range.js (29 bytes)
