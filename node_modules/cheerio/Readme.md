...
Cheerio works with a very simple, consistent DOM model. As a result parsing, manipulating, and rendering are incredibly efficient. Preliminary end-to-end ***REMOVED***chmarks suggest that cheerio is about __8x__ faster than JSDOM.
