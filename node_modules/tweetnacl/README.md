...
* [***REMOVED***chmarks](#***REMOVED***chmarks)
...
To run ***REMOVED***chmarks in Node.js:

    $ npm run ***REMOVED***ch
    $ NACL_SRC=nacl-fast.min.js npm run ***REMOVED***ch

To run ***REMOVED***chmarks in a browser, open `test/***REMOVED***chmark/***REMOVED***ch.html` (or
`test/***REMOVED***chmark/***REMOVED***ch-fast.html`).


***REMOVED***chmarks
----------

For reference, here are ***REMOVED***chmarks from MacBook Pro (Retina, 13-inch, Mid 2014)
...
(You can run ***REMOVED***chmarks on your devices by clicking on the links at the bottom
