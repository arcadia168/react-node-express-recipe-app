...
/*
 ...
 - DO NOT try to optimize yet. We get a tremendous ***REMOVED***efit out of comparing the output of each stage of the extend to the ruby
...
//          DEBUG_PRINTLN(EXTEND_COMPOUND, "ADDING NEW SELECTOR")
  ...
  */
  ...
  bool shouldExtendBlock(Block_Obj b) {
    ...
    // won't have any output. The main ***REMOVED***efit of this is for structures like:
    //
    //    .a {
    //      .b {
    //        x: y;
